...
#define XONGFUNC(name)Java_com_xong_libcode_jni_##name

extern "C" JNIEXPORT
jstring JNICALL
XONGFUNC(NativeCode_outputJsonCode)(JNIEnv *env, jclass thiz,
...
extern "C" JNIEXPORT
jstring JNICALL
XONGFUNC(NativeCode_parseJsonCode)(JNIEnv *env, jclass thiz,
                                            jstring jjson)
{
